...
Efficacy value for LGBTQ is 13%. The vaccine is not effective well enough to prevent the virus for this subgroup. Since the value is less than 50, so the alternative hypothesis is accepted while the null is rejected. 
